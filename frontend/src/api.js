...
export const getMarketBundle = async (symbol, timeframe) => {
  ...
  const [candles, swings, structure, fvg, analysis, liquidity, orderBlocks, premiumDiscount, bias, score] = await Promise.all([
  ...
  return { candles: candles.data, swings: swings.data, structure: structure.data, fvg: fvg.data, analysis: analysis.data, liquidity: liquidity.data, orderBlocks: orderBlocks.data, premiumDiscount: premiumDiscount.data, bias: bias.data, score: score.data }
}
